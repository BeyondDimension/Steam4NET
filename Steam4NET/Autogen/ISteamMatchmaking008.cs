...
namespace Steam4NET
{
    ...
    [InteropHelp.InterfaceVersion("SteamMatchMaking008")]
    public class ISteamMatchmaking008 : InteropHelp.NativeWrapper<ISteamMatchmaking008VTable>
    {
        ...
        {
            return this.GetFunction<NativeJoinLobbyC>(this.Functions.JoinLobby13)(this.ObjectAddress, steamIDLobby.ConvertToUint64());
        }
        ...
        {
            return InteropHelp.DecodeANSIReturn(Marshal.PtrToStringAnsi(this.GetFunction<NativeGetLobbyDataCS>(this.Functions.GetLobbyData18)(this.ObjectAddress, steamIDLobby.ConvertToUint64(), pchKey)));
        }
        ...
        {
            return InteropHelp.DecodeANSIReturn(Marshal.PtrToStringAnsi(this.GetFunction<NativeGetLobbyMemberDataCCS>(this.Functions.GetLobbyMemberData23)(this.ObjectAddress, steamIDLobby.ConvertToUint64(), steamIDUser.ConvertToUint64(), pchKey)));
        }
        ...
        {
            return this.GetFunction<NativeSetLobbyTypeCE>(this.Functions.SetLobbyType32)(this.ObjectAddress, steamIDLobby.ConvertToUint64(), eLobbyType);
        }
        ...
        {
            return this.GetFunction<NativeSetLobbyJoinableCB>(this.Functions.SetLobbyJoinable33)(this.ObjectAddress, steamIDLobby.ConvertToUint64(), bLobbyJoinable);
        }
        ...
        {
            UInt64 ret = 0; this.GetFunction<NativeGetLobbyOwnerC>(this.Functions.GetLobbyOwner34)(this.ObjectAddress, ref ret, steamIDLobby.ConvertToUint64()); return new CSteamID(ret);
        }
        ...
        {
            return this.GetFunction<NativeSetLobbyOwnerCC>(this.Functions.SetLobbyOwner35)(this.ObjectAddress, steamIDLobby.ConvertToUint64(), steamIDNewOwner.ConvertToUint64());
        }
    };
}