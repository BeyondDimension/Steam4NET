...
public class ISteamUser017VTable
{
    ...
    public IntPtr GetGameBadgeLevel22;
    public IntPtr GetPlayerSteamLevel23;
    private IntPtr DTorISteamUser01724;
};

[InteropHelp.InterfaceVersion("SteamUser017")]
public class ISteamUser017 : InteropHelp.NativeWrapper<ISteamUser017VTable>
{
    ...
    {
        return this.GetFunction<NativeGetGameBadgeLevelIB>(this.Functions.GetGameBadgeLevel22)(this.ObjectAddress, nSeries, bFoil);
    }
