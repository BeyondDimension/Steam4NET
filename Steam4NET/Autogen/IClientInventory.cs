...
namespace Steam4NET
{
    ...
    public class IClientInventoryVTable
    {
        ...
        private IntPtr DTorIClientInventory22;
    };

    public class IClientInventory : InteropHelp.NativeWrapper<IClientInventoryVTable>
    {
