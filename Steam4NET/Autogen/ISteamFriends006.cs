...
namespace Steam4NET
{
    ...
    public class ISteamFriends006 : InteropHelp.NativeWrapper<ISteamFriends006VTable>
    {
        ...
        {
            return this.GetFunction<NativeGetFriendCountFromSourceC>(this.Functions.GetFriendCountFromSource16)(this.ObjectAddress, steamIDSource.ConvertToUint64());
        }
        ...
        {
            UInt64 ret = 0; this.GetFunction<NativeGetFriendFromSourceByIndexCI>(this.Functions.GetFriendFromSourceByIndex17)(this.ObjectAddress, ref ret, steamIDSource.ConvertToUint64(), iFriend); return new CSteamID(ret);
        }
        ...
        {
            return this.GetFunction<NativeIsUserInSourceCC>(this.Functions.IsUserInSource18)(this.ObjectAddress, steamIDUser.ConvertToUint64(), steamIDSource.ConvertToUint64());
        }
        ...
        {
            this.GetFunction<NativeSetInGameVoiceSpeakingCB>(this.Functions.SetInGameVoiceSpeaking19)(this.ObjectAddress, steamIDUser.ConvertToUint64(), bSpeaking);
        }
        ...
        {
            this.GetFunction<NativeActivateGameOverlayS>(this.Functions.ActivateGameOverlay20)(this.ObjectAddress, pchDialog);
        }
        ...
        {
            this.GetFunction<NativeActivateGameOverlayToUserSC>(this.Functions.ActivateGameOverlayToUser21)(this.ObjectAddress, pchDialog, steamID.ConvertToUint64());
        }
        ...
        {
            this.GetFunction<NativeActivateGameOverlayToWebPageS>(this.Functions.ActivateGameOverlayToWebPage22)(this.ObjectAddress, pchURL);
        }
        ...
        {
            this.GetFunction<NativeActivateGameOverlayToStoreU>(this.Functions.ActivateGameOverlayToStore23)(this.ObjectAddress, nAppID);
        }
        ...
        {
            this.GetFunction<NativeSetPlayedWithC>(this.Functions.SetPlayedWith24)(this.ObjectAddress, steamIDUserPlayedWith.ConvertToUint64());
        }
        ...
        {
            this.GetFunction<NativeActivateGameOverlayInviteDialogC>(this.Functions.ActivateGameOverlayInviteDialog25)(this.ObjectAddress, steamIDLobby.ConvertToUint64());
        }
    };
}