...
namespace Steam4NET
{
    ...
    public class ISteamNetworking002 : InteropHelp.NativeWrapper<ISteamNetworking002VTable>
    {
        ...
        {
            return this.GetFunction<NativeCreateListenSocketIUUB>(this.Functions.CreateListenSocket0)(this.ObjectAddress, nVirtualP2PPort, nIP, nPort, bAllowUseOfPacketRelay);
        }
        ...
        {
            return this.GetFunction<NativeCreateP2PConnectionSocketCIIB>(this.Functions.CreateP2PConnectionSocket1)(this.ObjectAddress, steamIDTarget.ConvertToUint64(), nVirtualPort, nTimeoutSec, bAllowUseOfPacketRelay);
        }
        ...
        {
            return this.GetFunction<NativeRetrieveDataUBUUU>(this.Functions.RetrieveData9)(this.ObjectAddress, hListenSocket, pubDest, (UInt32)pubDest.Length, ref pcubMsgSize, ref phSocket);
        }

        [return: MarshalAs(UnmanagedType.I1)]
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate bool NativeGetSocketInfoUCEUU(IntPtr thisptr, UInt32 hSocket, ref UInt64 pSteamIDRemote, ref ESNetSocketState peSocketStatus, ref UInt32 punIPRemote, ref UInt16 punPortRemote);
        public bool GetSocketInfo(UInt32 hSocket, ref CSteamID pSteamIDRemote, ref ESNetSocketState peSocketStatus, ref UInt32 punIPRemote, ref UInt16 punPortRemote)
        {
            UInt64 s0 = 0; var result = this.GetFunction<NativeGetSocketInfoUCEUU>(this.Functions.GetSocketInfo10)(this.ObjectAddress, hSocket, ref s0, ref peSocketStatus, ref punIPRemote, ref punPortRemote); pSteamIDRemote = new CSteamID(s0); return result;
        }
        ...
        {
            return this.GetFunction<NativeGetSocketConnectionTypeU>(this.Functions.GetSocketConnectionType12)(this.ObjectAddress, hSocket);
        }
        ...
        {
            return this.GetFunction<NativeGetMaxPacketSizeU>(this.Functions.GetMaxPacketSize13)(this.ObjectAddress, hSocket);
        }
    };
}