...
namespace Steam4NET
{
    ...
    public class ISteamUser006 : InteropHelp.NativeWrapper<ISteamUser006VTable>
    {
        ...
        {
            return this.GetFunction<NativeInitiateGameConnectionBICCUUB>(this.Functions.InitiateGameConnection9)(this.ObjectAddress, pBlob, (Int32)pBlob.Length, steamID.ConvertToUint64(), nGameAppID.ConvertToUint64(), unIPServer, usPortServer, bSecure);
        }
