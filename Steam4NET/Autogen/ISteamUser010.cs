...
namespace Steam4NET
{
    ...
    [InteropHelp.InterfaceVersion("SteamUser010")]
    public class ISteamUser010 : InteropHelp.NativeWrapper<ISteamUser010VTable>
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate Int32 NativeInitiateGameConnectionBICUUB(IntPtr thisptr, Byte[] pBlob, Int32 cbMaxBlob, UInt64 steamID, UInt32 unIPServer, UInt16 usPortServer, [MarshalAs(UnmanagedType.I1)] bool bSecure);
        public Int32 InitiateGameConnection(Byte[] pBlob, CSteamID steamID, UInt32 unIPServer, UInt16 usPortServer, bool bSecure)
        {
            return this.GetFunction<NativeInitiateGameConnectionBICUUB>(this.Functions.InitiateGameConnection3)(this.ObjectAddress, pBlob, (Int32)pBlob.Length, steamID.ConvertToUint64(), unIPServer, usPortServer, bSecure);
        }
