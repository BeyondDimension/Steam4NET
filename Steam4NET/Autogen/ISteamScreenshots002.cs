...
public class ISteamScreenshots002VTable
{
    ...
    public IntPtr TagPublishedFile6;
    private IntPtr DTorISteamScreenshots0027;
};

[InteropHelp.InterfaceVersion("STEAMSCREENSHOTS_INTERFACE_VERSION002")]
public class ISteamScreenshots002 : InteropHelp.NativeWrapper<ISteamScreenshots002VTable>
{
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    [UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate bool NativeTagPublishedFileUU(IntPtr thisptr, UInt32 hScreenshot, UInt64 unPublishedFileId);
    public bool TagPublishedFile(UInt32 hScreenshot, UInt64 unPublishedFileId)
    {
        return this.GetFunction<NativeTagPublishedFileUU>(this.Functions.TagPublishedFile6)(this.ObjectAddress, hScreenshot, unPublishedFileId);
    }
};